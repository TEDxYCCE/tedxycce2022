...
export const speakersData: speaker[] = [
  ...
  },
  {
    ...
    Her journey, how she excel and still is exploring, also her life was not always sparkling and shining, she overcomed depression, her vision, her way to lead life will definitely bring change in everyone's vision.",
    photo: getPhotoURL("1", true),
  },
  {
    name: "Mithilesh Vazalwar",
    title: "Champion Coffee Roaster and National Level Badminton Player",
    desc: "Mithilesh Vazalwar is an ardent personality with an extremely innovative ideas and perception who believes &quot; making the perfect cup of coffee is a science &quot; . He is the Founder of Corridor Seven Coffee Roasters and an outstanding National Level Badminton Player. He belongs to the small number of Q Graders in India, professional cuppers who are accredited by the Coffee Quality Institute (CQI), an international non-profit that works towards improving the quality of coffee produced globally and is certified by Melbourne-based Veneziano Coffee Roasters. He is the First Indian AeroPress Champion and the 1st to have represented India at the World AeroPress Championship (W.A.C.), Seoul, South Korea, competing among Coffee Brewer Champions from over 50 Nations.",
    photo: getPhotoURL("1", true),
  },
  {
    name: "Sarvjeet Soni",
  ...
  {
    name: "Prachi Tehlan",
    title: "Software Athelete and Actress",
