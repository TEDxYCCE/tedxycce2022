const Footer = () => {
  return (
    <footer className="container flex flex-col items-center p-6 pt-8 mx-auto text-white bg-black lg:flex-row lg:flex-inverse lg:justify-between lg:items-center">
      <div>
        <ul id="socials" className="inline-flex gap-4 p-2 mt-10 text-red-700">
          <li>
            <a
