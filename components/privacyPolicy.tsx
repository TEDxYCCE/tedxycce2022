...
const Thanks = () => (
  <div className="container p-10 mx-auto text-center text-white border-2 border-red-800 ">
    ...
    <div className="font-mono text-justify">
      ...
      www.tedxycce.in, one of our main priorities is the privacy of our
      visitors. This Privacy Policy document contains types of information that
      is collected and recorded by tedxycce.in and how we use it. If you have
      ...
      the information that they shared and/or collect in tedxycce.in. This
      policy is not applicable to any information collected offline or via
      channels other than this website.
      <br />
      <ParaHeading>Consent</ParaHeading>
      <p>
        By using our website, you hereby consent to our Privacy Policy and agree
        to its terms.
      </p>
      <ParaHeading>Information we collect</ParaHeading>
      <p>
      ...
      <ParaHeading>How we use your information</ParaHeading>
      <p>
        We use the information we collect in various ways, including to:
        <ul className="list-disc">
          <li>Provide, operate, and maintain our Event and Website.</li>
          <li>Improve, personalize, and expand our Event and Website</li>
      ...
      <p className="mt-5">
        tedxycce.in follows a standard procedure of using log files. These files
      ...
      <ParaHeading>Third Party Privacy Policies</ParaHeading>
      <p>
        tedxycce.in`s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ...
        <ul className="list-disc">
          ...
          <li>
            <em>The right to erasure –</em>
            You have the right to request that we erase your personal data,
            under certain conditions.
          </li>
          <li>
            <em>The right to restrict processing –</em>
            You have the right to request that we restrict the processing of
            your personal data, under certain conditions.
          </li>
          <li>
            <em>The right to object to processing –</em>
            You have the right to object to our processing of your personal
            data, under certain conditions.{" "}
          </li>
          <li>
            <em>The right to data portability –</em>
      ...
      <p>
        <ParaHeading>Children`s Information</ParaHeading>
        Another part of our priority is adding protection for children while
        using the internet. We encourage parents and guardians to observe,
        participate in, and/or monitor and guide their online activity.
      </p>
      <p className="mt-5">
        tedxycce.in does not knowingly collect any Personal Identifiable
